...
RUN python -m py_compile app.py wsgi.py enriched_wsgi.py bbr_danskadresse.py danskadresse_full.py asbestos_guard.py datafordeler_asbestos.py property_inventory.py smoke_context.py \
